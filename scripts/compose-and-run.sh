...
#        COMPOSE_PLAYBOOK=<name>.yml to select a playbook under ansible/playbooks/ (default keycloak-aws.yml).
...
COMPOSE_PLAYBOOK_VALUE="${COMPOSE_PLAYBOOK-keycloak-aws.yml}"
